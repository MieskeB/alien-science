...
public class MoonBaseFeature extends JigsawFeature {
    private static final List<SpawnSettings.SpawnEntry> MONSTER_SPAWNS = ImmutableList.<SpawnSettings.SpawnEntry>builder().add(new SpawnSettings.SpawnEntry(AlienScienceEntityTypes.ALIEN, 100, 6, 10)).build();

    public MoonBaseFeature(Codec<StructurePoolFeatureConfig> codec) {
