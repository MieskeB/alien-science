...
public class TestingTentFeature extends StructureFeature<DefaultFeatureConfig> {
    public TestingTentFeature(Codec<DefaultFeatureConfig> codec) {
        super(codec);
    }
    ...
    public static class Start extends StructureStart<DefaultFeatureConfig> {
        ...
        public void init(DynamicRegistryManager registryManager, ChunkGenerator chunkGenerator, StructureManager manager, int chunkX,
            ...
            TestingTentGenerator.addPieces(manager, pos, rotation, this.children);
